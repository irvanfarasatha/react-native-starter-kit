...
import Layout from '../../components/Articles/View';
import { WebView } from 'react-native-webview';

class ArticlesWebView extends Component {
  constructor(props) {
    super();
...
export default connect(mapStateToProps, mapDispatchToProps)(ArticlesWebView);
